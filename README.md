...
- ### Linked Lists
    ...
    - [ ] implement (I did with tail pointer & without):
        ...
        - [x] findAt(index) - returns the value of the nth item (starting at 0 for first)
        ...
        - [x] topFront() - get value of front item
        - [x] topBack() - get value of end item
        - [x] addAfter(value, newValue) - insert newValue after value in the list
        - [x] addBefore(value, newValue) - insert newValue before value in the list
